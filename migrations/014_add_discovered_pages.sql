-- migrations/014_add_discovered_pages.sql
...
CREATE INDEX IF NOT EXISTS idx_discovered_pages_domain_active ON discovered_pages(domain, is_active);
...
DROP TRIGGER IF EXISTS trigger_update_discovered_pages_updated_at ON discovered_pages;
