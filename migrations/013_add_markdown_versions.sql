-- migrations/013_add_markdown_versions.sql
...
CREATE INDEX IF NOT EXISTS idx_markdown_versions_domain_active ON markdown_versions(domain, is_active);
...
DROP TRIGGER IF EXISTS trigger_update_markdown_versions_updated_at ON markdown_versions;
